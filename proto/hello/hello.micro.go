...
func (c *helloService) SayHello(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *helloHandler) SayHello(ctx context.Context, in *Request, out *Response) error {
